...
const AddCategory = () => {
  return (
    <Fragment>
      <NavBar />
      <main className={`container my-5 p-6 bg-white rounded-4 text-center shadow ${AddCategorystyle.container}`}>
        <h2 className={`${AddCategorystyle.title}`}>Palestine Red Crescent Society</h2>
        <img src={RedCrescent} alt="Red Crescent Logo" className={`${AddCategorystyle.my3}`} />
